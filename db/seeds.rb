...
Item.create(title: "Lucky Pennies", description: "A shiny heads-up penny you found in the road!", price: 999 , image: File.new("#{Rails.root}/app/assets/images/cartoon_penny.png"), categories: [Category.find_by(title: "Charms")])
...
Item.create(title: "Kitty", description: "so lucky", price: 999, image: File.new("#{Rails.root}/app/assets/images/lucky_cat.png"), categories: [Category.find_by(title: "Charms")])
#
