...
charms.items.create(title: "Lucky Pennies", description: "A shiny heads-up penny you found in the road!", price: 999 , image: File.new("#{Rails.root}/app/assets/images/cartoon_penny.png"))

charms.items.create(title: "Horseshoe", description: "Keep the open side pointed up so the luck doesn't drain out!", price: 1499, image: File.new("#{Rails.root}/app/assets/images/horseshoe.png"))

Item.create(title: "Kitty", description: "so lucky", price: 999, image: File.new("#{Rails.root}/app/assets/images/lucky_cat.png"), categories: [Category.first])
